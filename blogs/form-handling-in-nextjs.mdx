...
canonicalUrl: "http://localhost:3000/blog/form-handling-in-nextjs"
...
This is the only blog you will need to create real-world, error-free, customer-friendly, and safe form inputs.

> **Note:** I will be using NextJS to explain forms in the real world, but the concepts you will see are valid for other frameworks and libraries too.
...
> **Note:** So we could actually use both the action and onSubmit attributes on a form element. Action would be to make a POST request, and onSubmit would be for client-side validations or other work that will operate on the client.
...
![First Name Input Error](/firstnameerror.png)
